...
export default function Navbar() {
    return (
        <div className="bg-white flex items-center justify-between fixed inset-x-0 px-18 border py-4">
            ...
            <div className="flex shrink-0 items-center justify-end gap-2.5 border">
                    ...
                    <button className="inline-flex items-center justify-center gap-2 rounded-lg border border-black/10 px-4 py-3 font-medium text-sm text-black bg-transparent hover:bg-black/5 cursor-pointer">
                        <span className="size-5">
                            <Image width="20" height="14" className="size-full object-cover rounded-sm" src={en} alt="" />
                        </span>
                        <p>EN</p>
                ...
                <button className="font-medium text-white text-base bg-lime-500 hover:bg-lime-600 cursor-pointer rounded-lg px-6 py-2.5 duration-200">Goldex for Business</button>
